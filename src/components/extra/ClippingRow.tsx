...
//
// NOTE: the wrapper element exists so the attribution links are SIBLINGS of the
// row link. Nesting an anchor inside an anchor is invalid HTML and would make a
// single click mean two destinations, so the row link closes before they start.
